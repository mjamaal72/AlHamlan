...
#Region "Private properties"
    ...
    Private _HeaderFont As New Font(System.Drawing.FontFamily.GenericSansSerif, 10, FontStyle.Bold)
...
#Region "DataGrid"
    Public WriteOnly Property DataGrid() As DataGridView
    ...
    Private Sub _GridPrintDocument_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles _GridPrintDocument.PrintPage
        ...
        If _CurrentPageDown = 1 And _CurrentPageAcross = 1 Then
            ...
            For nColumn = 0 To ColumnCount - 1
                ...
                Try
                    rcLastCell = _DataGrid.GetCellDisplayRectangle(0, nColumn, True)
                Catch ex As Exception
                    'rcLastCell = _DataGrid.GetCellDisplayRectangle(0, nColumn - 1, True)
                    'flag = 1
                End Try
            ...
            For nColumn = 0 To ColumnCount - 1
                ...
                Try
                    rcCell = _DataGrid.GetCellDisplayRectangle(0, nColumn, True)
                Catch ex As Exception
                    'rcCell = _DataGrid.GetCellDisplayRectangle(0, nColumn - 1, True)
                    'flag = 1
                End Try
                If rcCell.Width > 0 Then
                    ...
                    End If
                End If
                If _ColumnBounds.RightExtents + NextColumn.Width > (e.MarginBounds.Left + e.MarginBounds.Width) And flag = 0 Then
...
#Region "Private methods"
    ...
    Private Sub PrintGridHeaderLine(ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        For nColumn = 0 To GridColumnCount() - 1
            If _ColumnBounds(nColumn).Page = _CurrentPageAcross Then
                Dim rcCell As New Rectangle(CInt(_ColumnBounds(nColumn).Left), CInt(Top), CInt(_ColumnBounds(nColumn).Width), CInt(Bottom - Top))
                If rcCell.Width > 0 Then
                    Call DrawCellString(GetColumnHeadingText(nColumn), CellTextHorizontalAlignment.CentreAlign, CellTextVerticalAlignment.MiddleAlign, rcCell, True, e.Graphics, _HeaderFont, _ColumnHeaderBrush)
                End If
            End If
        Next
    ...
    Private Function GridColumnCount() As Integer
        ...
        If _GridColumnCount = 0 Then
            If TypeOf _DataGrid.DataSource Is DataTable Then
                ...
                For Each col As DataGridViewColumn In _DataGrid.Columns
                    If col.Visible = True Then
                        VisColCount += 1
                    End If
                Next
                _GridColumnCount = VisColCount
    ...
    Private Function GetColumnHeadingText(ByVal Column As Integer) As String
        ...
        If _DataGrid.ColumnCount > 0 Then
            Return _DataGrid.Columns(Column).HeaderText
        Else
            If TypeOf _DataGrid.DataSource Is DataTable Then
    ...
    Private Function MappedColumnToBaseColumn(ByVal MappedColumn As Integer) As Integer
        ...
        If _DataGrid.ColumnCount <= 1 Then
            Return MappedColumn
        Else
            ...
            Return _DataGrid.Columns(MappedColumn).Index
        End If
...
#Region "Public constructors"
    ...
    Public Sub New(ByVal Grid As DataGridView)
        ...
        _LoggedInUsername = MainMDI.LblInitials.Text
    End Sub
#End Region
