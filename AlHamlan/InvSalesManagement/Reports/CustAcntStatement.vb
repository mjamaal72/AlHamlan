...
Public Class CustAcntStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AlHamlan.CustAcntStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustAcntStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustAcntStatement = New CustAcntStatement()
        rpt.Site = Me.Site
        Return rpt
    End Function
