...
Public Class CustRCThermal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AlHamlan.CustRCThermal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCustRCThermal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CustRCThermal = New CustRCThermal()
        rpt.Site = Me.Site
        Return rpt
    End Function
