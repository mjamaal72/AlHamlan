...
Public Class GRNRepThermal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AlHamlan.GRNRepThermal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGRNRepThermal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GRNRepThermal = New GRNRepThermal()
        rpt.Site = Me.Site
        Return rpt
    End Function
