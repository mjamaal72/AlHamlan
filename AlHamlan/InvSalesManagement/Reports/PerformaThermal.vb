...
Public Class PerformaThermal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AlHamlan.PerformaThermal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPerformaThermal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PerformaThermal = New PerformaThermal()
        rpt.Site = Me.Site
        Return rpt
    End Function
