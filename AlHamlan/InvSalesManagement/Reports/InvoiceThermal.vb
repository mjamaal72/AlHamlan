...
Public Class InvoiceThermal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AlHamlan.InvoiceThermal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInvoiceThermal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InvoiceThermal = New InvoiceThermal()
        rpt.Site = Me.Site
        Return rpt
    End Function
