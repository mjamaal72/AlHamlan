...
#End Region
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        CmdStr = "Select * from View_PO_Dtls Where PUR_ORDER_NO Is Not Null "
        ...
        If cbitem.SelectedValue <> Nothing Then
            CmdStr = CmdStr + " AND PUR_ITM_CODE = '" + cbitem.SelectedValue + "'"
        End If
        If txtpono.Text <> "" Then
            CmdStr = CmdStr + " AND PUR_ORDER_NO = " + cbitem.SelectedValue + ""
        End If
        If rbPndng.Checked = True Then
            CmdStr = CmdStr + " AND PUR_QTY_BALANCE > 0"
        ElseIf rbCmplt.Checked = True Then
            CmdStr = CmdStr + " AND PUR_QTY_BALANCE = 0"
        ElseIf rbCncl.Checked = True Then
            CmdStr = CmdStr + " AND PUR_QTY_CANCELLED > 0"
        ElseIf rbMore.Checked = True Then
            CmdStr = CmdStr + " AND PUR_QTY_BALANCE < 0"
        End If
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        AccessVerify.DGVPrinting("Purchase Order Status Report", "", False, DataGridView1)
    End Sub
    ...
    Private Sub Me_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        cmd.CommandText = "Select Distinct PUR_ITM_CODE +' | '+  ITEM_DESC As ItemName, PUR_ITM_CODE from View_PO_Dtls Order By PUR_ITM_CODE"
        da = New SqlDataAdapter(cmd)
        da.Fill(ds, "View_PO_Dtls")
        cbitem.DisplayMember = "ItemName"
        cbitem.ValueMember = "PUR_ITM_CODE"
        cbitem.DataSource = ds.Tables("View_PO_Dtls")
