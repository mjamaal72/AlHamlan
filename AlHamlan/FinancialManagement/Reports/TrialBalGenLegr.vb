...
Public Class TrialBalGenLegr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AlHamlan.TrialBalGenLegr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTrialBalGenLegr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TrialBalGenLegr = New TrialBalGenLegr()
        rpt.Site = Me.Site
        Return rpt
    End Function
