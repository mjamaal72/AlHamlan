...
Public Class TrialBalSubLegr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AlHamlan.TrialBalSubLegr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTrialBalSubLegr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TrialBalSubLegr = New TrialBalSubLegr()
        rpt.Site = Me.Site
        Return rpt
    End Function
