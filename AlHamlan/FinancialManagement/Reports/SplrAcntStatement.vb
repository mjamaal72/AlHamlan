...
Public Class SplrAcntStatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AlHamlan.SplrAcntStatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSplrAcntStatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SplrAcntStatement = New SplrAcntStatement()
        rpt.Site = Me.Site
        Return rpt
    End Function
