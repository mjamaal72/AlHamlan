...
Public Class BalSheetGenLegr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AlHamlan.BalSheetGenLegr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBalSheetGenLegr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BalSheetGenLegr = New BalSheetGenLegr()
        rpt.Site = Me.Site
        Return rpt
    End Function
