...
Public Class BalSheetSubLegr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AlHamlan.BalSheetSubLegr.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBalSheetSubLegr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BalSheetSubLegr = New BalSheetSubLegr()
        rpt.Site = Me.Site
        Return rpt
    End Function
